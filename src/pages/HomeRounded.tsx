...
// import ServiceCardRounded from '../components/ServiceCardRounded';
  ...
  <div>
   ...
   {/* <section className="py-16 bg-gray-50">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div className="text-center mb-12">
      <h2 className="text-3xl lg:text-4xl font-bold text-sra-primary mb-4 uppercase tracking-wide">
       {t('home.stats.title')}
      </h2>
      <div className="w-24 h-1 bg-sra-orange mx-auto mb-4 rounded-full"></div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {services.map((service, index) => (
       <ServiceCardRounded key={index} {...service} />
      ))}
     </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div className="space-y-6">
       ...
       <div className="w-24 h-1 bg-sra-orange rounded-full"></div>
   ...
   {/* <section className="py-16 bg-sra-primary text-white">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
     ...
     <div className="w-24 h-1 bg-sra-orange mx-auto mb-6 rounded-full"></div>
