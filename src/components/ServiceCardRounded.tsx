...
interface ServiceCardRoundedProps {
 title: string;
 description: string;
 icon: LucideIcon;
...
const ServiceCardRounded: React.FC<ServiceCardRoundedProps> = ({ title, description, icon: Icon, color }) => {
 const colorClasses = {
  primary: {
...
export default ServiceCardRounded; 